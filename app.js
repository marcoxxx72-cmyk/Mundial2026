...
var STARS = [
  ...
  {name:'Lamine Yamal',role:'RW',flag:'🇪🇸',club:'FC Barcelona',pos:'FW',age:17,stat:'Euro 2024 champion',rating:91,pac:92,sho:86,pas:81,dri:91,def_:43,phy:69},
  ...
  {name:'Marcus Thuram',role:'CF',flag:'🇫🇷',club:'Inter Milan',pos:'FW',age:26,stat:'Serie A champion 2024',rating:87,pac:84,sho:88,pas:75,dri:82,def_:42,phy:69},
    {name:'Raphinha',role:'LW',flag:'🇧🇷',club:'FC Barcelona',pos:'FW',age:28,stat:'Champions League 2025',rating:86,pac:87,sho:81,pas:76,dri:86,def_:40,phy:64},
  {name:'Robert Lewandowski',role:'CF',flag:'🇵🇱',club:'FC Barcelona',pos:'FW',age:36,stat:'5x top scorer',rating:86,pac:83,sho:87,pas:74,dri:81,def_:41,phy:68},
  ...
  {name:'Dusan Vlahovic',role:'CF',flag:'🇷🇸',club:'Juventus',pos:'FW',age:24,stat:'Serie A top scorer',rating:85,pac:82,sho:86,pas:73,dri:80,def_:40,phy:67},
  ...
  {name:'Jonathan David',role:'CF',flag:'🇨🇦',club:'Lille',pos:'FW',age:24,stat:'Ligue 1 top scorer 2024',rating:84,pac:81,sho:85,pas:72,dri:79,def_:40,phy:66},
  {name:'Alvaro Morata',flag:'🇪🇸',club:'AC Milan',pos:'FW',age:31,stat:'Euro 2024 champion',rating:84,pac:82,sho:84,pas:74,dri:80,def_:40,phy:64},
  {name:'Richarlison',role:'RW',flag:'🇧🇷',club:'Tottenham',pos:'FW',age:27,stat:'WC 2022 Brazil',rating:84,pac:85,sho:79,pas:74,dri:84,def_:40,phy:62},
  ...
  {name:'Donyell Malen',role:'RW',flag:'🇳🇱',club:'Aston Villa',pos:'FW',age:26,stat:'Bundesliga top scorer 2023',rating:83,pac:84,sho:78,pas:73,dri:83,def_:40,phy:61},
  {name:'Memphis Depay',role:'LW',flag:'🇳🇱',club:'Atletico Madrid',pos:'FW',age:30,stat:'Dutch all-time top scorer',rating:83,pac:84,sho:78,pas:73,dri:83,def_:40,phy:61},
  {name:'Victor Boniface',role:'CF',flag:'🇳🇬',club:'Bayer Leverkusen',pos:'FW',age:23,stat:'Bundesliga champion 2024',rating:83,pac:80,sho:84,pas:71,dri:78,def_:40,phy:65},
  {name:'Rasmus Hojlund',role:'CF',flag:'🇩🇰',club:'Man. Utd',pos:'FW',age:22,stat:'Denmark top striker',rating:83,pac:80,sho:84,pas:71,dri:78,def_:40,phy:65},
  ...
  {name:'Ivan Toney',role:'CF',flag:'🏴󠁧󠁢󠁥󠁮󠁧󠁿',club:'Al-Ahli',pos:'FW',age:29,stat:'England squad 2024',rating:82,pac:79,sho:83,pas:70,dri:77,def_:40,phy:64},
    {name:'Evan Ferguson',role:'CF',flag:'🇮🇪',club:'Brighton',pos:'FW',age:20,stat:'Ireland rising star',rating:81,pac:78,sho:82,pas:69,dri:76,def_:40,phy:63},
  {name:'Youssoufa Moukoko',flag:'🇩🇪',club:'Nice',pos:'FW',age:20,stat:'Germany young star',rating:81,pac:79,sho:81,pas:71,dri:77,def_:40,phy:61},
  ...
  {name:'Phil Foden',flag:'🏴󠁧󠁢󠁥󠁮󠁧󠁿',club:'Man. City',pos:'MF',age:24,stat:'PFA Player of Year 2024',rating:88,pac:80,sho:73,pas:89,dri:82,def_:68,phy:74},
  ...
  {name:'Florian Wirtz',flag:'🇩🇪',club:'Bayer Leverkusen',pos:'MF',age:21,stat:'Bundesliga champion 2024',rating:87,pac:79,sho:72,pas:88,dri:81,def_:67,phy:73},
  {name:'Khvicha Kvaratskhelia',flag:'🇬🇪',club:'PSG',pos:'MF',age:23,stat:'Serie A best player 2023',rating:86,pac:78,sho:71,pas:87,dri:80,def_:66,phy:72},
  ...
  {name:'Eduardo Camavinga',flag:'🇫🇷',club:'Real Madrid',pos:'MF',age:21,stat:'UCL winner 2024',rating:85,pac:77,sho:70,pas:86,dri:79,def_:65,phy:71},
  ...
  {name:'Ilkay Gundogan',flag:'🇩🇪',club:'FC Barcelona',pos:'MF',age:33,stat:'PL POTY 2023',rating:85,pac:77,sho:70,pas:86,dri:79,def_:65,phy:71},
  {name:'Granit Xhaka',flag:'🇨🇭',club:'Bayer Leverkusen',pos:'MF',age:31,stat:'Bundesliga champion 2024',rating:84,pac:76,sho:69,pas:85,dri:78,def_:64,phy:70},
  {name:'Luka Modric',flag:'🇭🇷',club:'Real Madrid',pos:'MF',age:39,stat:'WC 2022 finalist',rating:84,pac:76,sho:69,pas:85,dri:78,def_:64,phy:70},
  ...
  {name:'Dominik Szoboszlai',flag:'🇭🇺',club:'Liverpool',pos:'MF',age:24,stat:'Hungary captain',rating:84,pac:76,sho:69,pas:85,dri:78,def_:64,phy:70},
  ...
  {name:'Xavi Simons',flag:'🇳🇱',club:'Leipzig',pos:'MF',age:22,stat:'Bundesliga rising star',rating:83,pac:75,sho:68,pas:84,dri:77,def_:63,phy:69},
  ...
  {name:'Sofyan Amrabat',flag:'🇲🇦',club:'Fiorentina',pos:'MF',age:28,stat:'WC 2022 best MF',rating:83,pac:75,sho:68,pas:84,dri:77,def_:63,phy:69},
  ...
  {name:'Trent Alexander-Arnold',flag:'🏴󠁧󠁢󠁥󠁮󠁧󠁿',club:'Real Madrid',pos:'DF',age:26,stat:'UCL winner',rating:87,pac:82,sho:52,pas:75,dri:67,def_:89,phy:79},
  ...
  {name:'Theo Hernandez',flag:'🇫🇷',club:'AC Milan',pos:'DF',age:26,stat:'Serie A champion',rating:86,pac:81,sho:51,pas:74,dri:66,def_:88,phy:78},
  {name:'Marquinhos',flag:'🇧🇷',club:'PSG',pos:'DF',age:30,stat:'UCL finalist 2020',rating:86,pac:81,sho:51,pas:74,dri:66,def_:88,phy:78},
  {name:'Eder Militao',flag:'🇧🇷',club:'Real Madrid',pos:'DF',age:26,stat:'UCL winner 2022',rating:85,pac:80,sho:50,pas:73,dri:65,def_:87,phy:77},
  {name:'Dani Carvajal',flag:'🇪🇸',club:'Real Madrid',pos:'DF',age:32,stat:'UCL winner 2024',rating:85,pac:80,sho:50,pas:73,dri:65,def_:87,phy:77},
  ...
  {name:'Jeremie Frimpong',flag:'🇳🇱',club:'Bayer Leverkusen',pos:'DF',age:24,stat:'Bundesliga champion 2024',rating:83,pac:78,sho:48,pas:71,dri:63,def_:85,phy:75},
  ...
  {name:'Kyle Walker',flag:'🏴󠁧󠁢󠁥󠁮󠁧󠁿',club:'AC Milan',pos:'DF',age:34,stat:'PL champion x6',rating:83,pac:78,sho:48,pas:71,dri:63,def_:85,phy:75},
  {name:'Ben White',flag:'🏴󠁧󠁢󠁥󠁮󠁧󠁿',club:'Arsenal',pos:'DF',age:27,stat:'PL top defender 2024',rating:83,pac:78,sho:48,pas:71,dri:63,def_:85,phy:75},
  {name:'Kieran Trippier',flag:'🏴󠁧󠁢󠁥󠁮󠁧󠁿',club:'Newcastle',pos:'DF',age:34,stat:'PL best RB 2022',rating:83,pac:78,sho:48,pas:71,dri:63,def_:85,phy:75},
  {name:'Vanderson',flag:'🇧🇷',club:'Monaco',pos:'DF',age:23,stat:'Brazil right back',rating:82,pac:77,sho:47,pas:70,dri:62,def_:84,phy:74},
  ...
  {name:'Marc-Andre ter Stegen',flag:'🇩🇪',club:'FC Barcelona',pos:'GK',age:32,stat:'Best GK La Liga',rating:86,pac:61,sho:40,pas:66,dri:40,def_:86,phy:71},
  ...
  {name:'Yann Sommer',flag:'🇨🇭',club:'Inter Milan',pos:'GK',age:35,stat:'Serie A champion 2024',rating:84,pac:59,sho:40,pas:64,dri:40,def_:84,phy:69},
  ...
  {name:'Gregor Kobel',flag:'🇨🇭',club:'Borussia Dortmund',pos:'GK',age:27,stat:'UCL finalist 2024',rating:84,pac:59,sho:40,pas:64,dri:40,def_:84,phy:69},
  ...
  {name:'Andre Onana',flag:'🇨🇲',club:'Man. Utd',pos:'GK',age:28,stat:'UCL finalist 2023',rating:83,pac:58,sho:40,pas:63,dri:40,def_:83,phy:68},
  {name:'Gregor Kobel',flag:'🇨🇭',club:'Borussia Dortmund',pos:'GK',age:27,stat:'UCL finalist 2024',rating:84,pac:59,sho:40,pas:64,dri:40,def_:84,phy:69},
  ...
  // ── MORE FORWARDS ──
  {name:'Gabriel Jesus',role:'CF',flag:'🇧🇷',club:'Arsenal',pos:'FW',age:27,stat:'PL champion 2022',rating:83,pac:80,sho:84,pas:71,dri:78,def_:40,phy:65},
    {name:'Memphis Depay',flag:'🇳🇱',club:'Atletico Madrid',pos:'FW',age:30,stat:'Dutch top scorer',rating:83,pac:81,sho:83,pas:73,dri:79,def_:40,phy:63},
  {name:'Andre Silva',flag:'🇵🇹',club:'Leipzig',pos:'FW',age:29,stat:'Bundesliga top scorer 2021',rating:82,pac:80,sho:82,pas:72,dri:78,def_:40,phy:62},
  {name:'Breel Embolo',role:'CF',flag:'🇨🇭',club:'Monaco',pos:'FW',age:27,stat:'Switzerland captain',rating:82,pac:79,sho:83,pas:70,dri:77,def_:40,phy:64},
  ...
  {name:'Ansu Fati',role:'RW',flag:'🇪🇸',club:'FC Barcelona',pos:'FW',age:22,stat:'Spain young star',rating:82,pac:83,sho:77,pas:72,dri:82,def_:40,phy:60},
  {name:'Kaoru Mitoma',role:'RW',flag:'🇯🇵',club:'Brighton',pos:'FW',age:27,stat:'Japan best player',rating:83,pac:84,sho:78,pas:73,dri:83,def_:40,phy:61},
  ...
  {name:'Mason Mount',flag:'🏴󠁧󠁢󠁥󠁮󠁧󠁿',club:'Man. Utd',pos:'MF',age:26,stat:'UCL winner 2021',rating:82,pac:74,sho:67,pas:83,dri:76,def_:62,phy:68},
  {name:'Leandro Paredes',flag:'🇦🇷',club:'Roma',pos:'MF',age:30,stat:'WC 2022 champion',rating:82,pac:74,sho:67,pas:83,dri:76,def_:62,phy:68},
  {name:'Rodrigo De Paul',flag:'🇦🇷',club:'Atletico Madrid',pos:'MF',age:30,stat:'WC 2022 champion',rating:83,pac:75,sho:68,pas:84,dri:77,def_:63,phy:69},
  ...
  {name:'Piotr Zielinski',flag:'🇵🇱',club:'Inter Milan',pos:'MF',age:30,stat:'Serie A champion 2024',rating:83,pac:75,sho:68,pas:84,dri:77,def_:63,phy:69},
  {name:'Mateus Fernandes',flag:'🇵🇹',club:'Southampton',pos:'MF',age:21,stat:'Portugal rising star',rating:81,pac:73,sho:66,pas:82,dri:75,def_:61,phy:67},
  ...
  {name:'Gabri Veiga',flag:'🇪🇸',club:'Al-Qadsiah',pos:'MF',age:22,stat:'Spain U21 champion',rating:81,pac:73,sho:66,pas:82,dri:75,def_:61,phy:67},

  // ── MORE DEFENDERS ──
  {name:'Jordi Alba',flag:'🇪🇸',club:'Inter Miami',pos:'DF',age:35,stat:'Euro 2012/2024 winner',rating:80,pac:75,sho:45,pas:68,dri:60,def_:82,phy:72},
  {name:'Presnel Kimpembe',flag:'🇫🇷',club:'PSG',pos:'DF',age:28,stat:'France squad',rating:82,pac:77,sho:47,pas:70,dri:62,def_:84,phy:74},
  ...
  {name:'Levi Colwill',flag:'🏴󠁧󠁢󠁥󠁮󠁧󠁿',club:'Chelsea',pos:'DF',age:22,stat:'England U21 captain',rating:82,pac:77,sho:47,pas:70,dri:62,def_:84,phy:74},
  ...
  {name:'Fabian Schar',flag:'🇨🇭',club:'Newcastle',pos:'DF',age:32,stat:'Switzerland captain',rating:82,pac:77,sho:47,pas:70,dri:62,def_:84,phy:74},
  {name:'Rayan Ait-Nouri',flag:'🇩🇿',club:'Wolves',pos:'DF',age:23,stat:'Algeria No.1 LB',rating:82,pac:77,sho:47,pas:70,dri:62,def_:84,phy:74},
  {name:'Nuno Tavares',flag:'🇵🇹',club:'Lazio',pos:'DF',age:24,stat:'Portugal squad 2024',rating:81,pac:76,sho:46,pas:69,dri:61,def_:83,phy:73},

  // ── MORE GOALKEEPERS ──
  {name:'Raya David',flag:'🇪🇸',club:'Arsenal',pos:'GK',age:29,stat:'PL Golden Glove 2024',rating:85,pac:60,sho:40,pas:65,dri:40,def_:85,phy:70},
  {name:'Matz Sels',flag:'🇧🇪',club:'Nottm Forest',pos:'GK',age:32,stat:'Belgium No.1',rating:82,pac:57,sho:40,pas:62,dri:40,def_:82,phy:67},
  {name:'Predrag Rajkovic',flag:'🇷🇸',club:'Atletico Madrid',pos:'GK',age:30,stat:'Serbia No.1',rating:82,pac:57,sho:40,pas:62,dri:40,def_:82,phy:67},
  {name:'Bono',flag:'🇲🇦',club:'Al-Qadsiah',pos:'GK',age:33,stat:'Morocco WC 2022 hero',rating:83,pac:58,sho:40,pas:63,dri:40,def_:83,phy:68},
  {name:'Lukasz Fabianski',flag:'🇵🇱',club:'West Ham',pos:'GK',age:39,stat:'Poland veteran',rating:80,pac:55,sho:40,pas:60,dri:40,def_:80,phy:65},
  // ── EXTRA FORWARDS (target 50 FW) ──
  {name:'Richarlison',flag:'🇧🇷',club:'Tottenham',pos:'FW',age:27,stat:'WC 2022 Brazil',rating:84,pac:82,sho:84,pas:74,dri:80,def_:40,phy:64},
  ...
  {name:'Pedro',role:'CF',flag:'🇧🇷',club:'Flamengo',pos:'FW',age:27,stat:'Copa Libertadores winner',rating:83,pac:80,sho:84,pas:71,dri:78,def_:40,phy:65},
  {name:'Neymar Jr',role:'CF',flag:'🇧🇷',club:'Al-Hilal',pos:'FW',age:33,stat:'Brazil record scorer',rating:85,pac:82,sho:86,pas:73,dri:80,def_:40,phy:67},
  ...
  {name:'Darwin Nunez',flag:'🇺🇾',club:'Liverpool',pos:'FW',age:25,stat:'Copa America 2024',rating:84,pac:82,sho:84,pas:74,dri:80,def_:40,phy:64},
  {name:'Ferran Torres',flag:'🇪🇸',club:'FC Barcelona',pos:'FW',age:24,stat:'Euro 2024 champion',rating:83,pac:81,sho:83,pas:73,dri:79,def_:40,phy:63},
  {name:'Kaoru Mitoma',flag:'🇯🇵',club:'Brighton',pos:'FW',age:27,stat:'Japan best player',rating:83,pac:81,sho:83,pas:73,dri:79,def_:40,phy:63},
  {name:'Hwang Hee-chan',flag:'🇰🇷',club:'Wolves',pos:'FW',age:28,stat:'South Korea No.9',rating:82,pac:80,sho:82,pas:72,dri:78,def_:40,phy:62},
  {name:'Gabriel Jesus',flag:'🇧🇷',club:'Arsenal',pos:'FW',age:27,stat:'PL champion 2022',rating:83,pac:81,sho:83,pas:73,dri:79,def_:40,phy:63},
  {name:'Breel Embolo',flag:'🇨🇭',club:'Monaco',pos:'FW',age:27,stat:'Switzerland striker',rating:82,pac:80,sho:82,pas:72,dri:78,def_:40,phy:62},
  {name:'Andre Silva',flag:'🇵🇹',club:'Leipzig',pos:'FW',age:29,stat:'Bundesliga top scorer 2021',rating:82,pac:80,sho:82,pas:72,dri:78,def_:40,phy:62},
  ...
  {name:'Edin Dzeko',flag:'🇧🇦',club:'Fenerbahce',pos:'FW',age:38,stat:'Bosnia legend',rating:80,pac:78,sho:80,pas:70,dri:76,def_:40,phy:60},
    {name:'Teemu Pukki',flag:'🇫🇮',club:'Celtic',pos:'FW',age:34,stat:'Finland captain',rating:80,pac:78,sho:80,pas:70,dri:76,def_:40,phy:60},
  {name:'Timo Werner',role:'CF',flag:'🇩🇪',club:'Tottenham',pos:'FW',age:28,stat:'Germany Euro 2024',rating:82,pac:79,sho:83,pas:70,dri:77,def_:40,phy:64},
  ...
  {name:'Sadio Mane',flag:'🇸🇳',club:'Al Nassr',pos:'FW',age:32,stat:'AFCON winner 2022',rating:84,pac:82,sho:84,pas:74,dri:80,def_:40,phy:64},
  ...
  {name:'Mason Mount',flag:'🏴󠁧󠁢󠁥󠁮󠁧󠁿',club:'Man. Utd',pos:'MF',age:26,stat:'UCL winner 2021',rating:82,pac:74,sho:67,pas:83,dri:76,def_:62,phy:68},
  {name:'Yusuf Yazici',flag:'🇹🇷',club:'Lille',pos:'MF',age:27,stat:'Turkey Euro 2024',rating:81,pac:73,sho:66,pas:82,dri:75,def_:61,phy:67},
  {name:'James Maddison',flag:'🏴󠁧󠁢󠁥󠁮󠁧󠁿',club:'Tottenham',pos:'MF',age:28,stat:'PL best creative 2024',rating:84,pac:76,sho:69,pas:85,dri:78,def_:64,phy:70},
  ...
  {name:'Mateus Fernandes',flag:'🇵🇹',club:'Southampton',pos:'MF',age:21,stat:'Portugal rising star',rating:81,pac:73,sho:66,pas:82,dri:75,def_:61,phy:67},
  {name:'Gabri Veiga',flag:'🇪🇸',club:'Al-Qadsiah',pos:'MF',age:22,stat:'Spain U21',rating:81,pac:73,sho:66,pas:82,dri:75,def_:61,phy:67},
  ...
  {name:'Conor Gallagher',flag:'🏴󠁧󠁢󠁥󠁮󠁧󠁿',club:'Atletico Madrid',pos:'MF',age:24,stat:'England Euro 2024',rating:82,pac:74,sho:67,pas:83,dri:76,def_:62,phy:68},
  {name:'Matias Vecino',flag:'🇺🇾',club:'Lazio',pos:'MF',age:33,stat:'Uruguay captain',rating:81,pac:73,sho:66,pas:82,dri:75,def_:61,phy:67},
  ...
  {name:'Sandro Tonali',flag:'🇮🇹',club:'Newcastle',pos:'MF',age:24,stat:'Serie A champion 2022',rating:83,pac:75,sho:68,pas:84,dri:77,def_:63,phy:69},
  {name:'Przemyslaw Frankowski',flag:'🇵🇱',club:'Lens',pos:'MF',age:29,stat:'Poland wing',rating:81,pac:73,sho:66,pas:82,dri:75,def_:61,phy:67},
  {name:'Ivan Ilic',flag:'🇷🇸',club:'Torino',pos:'MF',age:23,stat:'Serbia rising star',rating:81,pac:73,sho:66,pas:82,dri:75,def_:61,phy:67},
  {name:'Kevin De Bruyne',flag:'🇧🇪',club:'Man. City',pos:'MF',age:33,stat:'PL best midfielder',rating:91,pac:83,sho:76,pas:92,dri:85,def_:71,phy:77},
    {name:'N Golo Kante',flag:'🇫🇷',club:'Al Ittihad',pos:'MF',age:33,stat:'WC 2018 winner',rating:85,pac:77,sho:70,pas:86,dri:79,def_:65,phy:71},
  ...
  {name:'Micky van de Ven',flag:'🇳🇱',club:'Tottenham',pos:'DF',age:23,stat:'PL fastest player',rating:83,pac:78,sho:48,pas:71,dri:63,def_:85,phy:75},
  {name:'Fabian Schar',flag:'🇨🇭',club:'Newcastle',pos:'DF',age:32,stat:'Switzerland captain',rating:82,pac:77,sho:47,pas:70,dri:62,def_:84,phy:74},
  {name:'Rayan Ait-Nouri',flag:'🇩🇿',club:'Wolves',pos:'DF',age:23,stat:'Algeria LB',rating:82,pac:77,sho:47,pas:70,dri:62,def_:84,phy:74},
  {name:'Nuno Tavares',flag:'🇵🇹',club:'Lazio',pos:'DF',age:24,stat:'Portugal squad',rating:81,pac:76,sho:46,pas:69,dri:61,def_:83,phy:73},
  ...
  {name:'Nordi Mukiele',flag:'🇫🇷',club:'PSG',pos:'DF',age:26,stat:'France squad',rating:82,pac:77,sho:47,pas:70,dri:62,def_:84,phy:74},
  ...
  {name:'Konstantinos Tsimikas',flag:'🇬🇷',club:'Liverpool',pos:'DF',age:28,stat:'Greece captain',rating:82,pac:77,sho:47,pas:70,dri:62,def_:84,phy:74},
  ...
  {name:'Jeremie Frimpong',flag:'🇳🇱',club:'Bayer Leverkusen',pos:'DF',age:24,stat:'Bundesliga champion',rating:83,pac:78,sho:48,pas:71,dri:63,def_:85,phy:75},
  {name:'Vanderson',flag:'🇧🇷',club:'Monaco',pos:'DF',age:23,stat:'Brazil right back',rating:82,pac:77,sho:47,pas:70,dri:62,def_:84,phy:74},
  {name:'Destiny Udogie',flag:'🇮🇹',club:'Tottenham',pos:'DF',age:22,stat:'Italy Euro 2024',rating:82,pac:77,sho:47,pas:70,dri:62,def_:84,phy:74},
  {name:'Theo Hernandez',flag:'🇫🇷',club:'AC Milan',pos:'DF',age:27,stat:'Serie A champion',rating:86,pac:81,sho:51,pas:74,dri:66,def_:88,phy:78},
  {name:'Stefan de Vrij',flag:'🇳🇱',club:'Inter Milan',pos:'DF',age:32,stat:'Serie A champion 2024',rating:84,pac:79,sho:49,pas:72,dri:64,def_:86,phy:76},
  {name:'Danilo',flag:'🇧🇷',club:'Juventus',pos:'DF',age:33,stat:'Brazil captain',rating:83,pac:78,sho:48,pas:71,dri:63,def_:85,phy:75},
  {name:'Cesar Azpilicueta',flag:'🇪🇸',club:'Atletico Madrid',pos:'DF',age:34,stat:'Euro 2024 champion',rating:81,pac:76,sho:46,pas:69,dri:61,def_:83,phy:73},
  ...
  {name:'Bono',flag:'🇲🇦',club:'Al-Qadsiah',pos:'GK',age:33,stat:'Morocco WC 2022 hero',rating:83,pac:58,sho:40,pas:63,dri:40,def_:83,phy:68},
  {name:'Lukasz Fabianski',flag:'🇵🇱',club:'West Ham',pos:'GK',age:39,stat:'Poland veteran',rating:80,pac:55,sho:40,pas:60,dri:40,def_:80,phy:65},
  {name:'Caoimhin Kelleher',flag:'🇮🇪',club:'Liverpool',pos:'GK',age:25,stat:'Ireland No.1',rating:82,pac:57,sho:40,pas:62,dri:40,def_:82,phy:67},
  ...
  {name:'Giorgi Mamardashvili',flag:'🇬🇪',club:'Liverpool',pos:'GK',age:23,stat:'Georgia hero Euro 2024',rating:84,pac:59,sho:40,pas:64,dri:40,def_:84,phy:69},
  {name:'Filip Jorgensen',flag:'🇩🇰',club:'Chelsea',pos:'GK',age:22,stat:'Denmark rising star',rating:82,pac:57,sho:40,pas:62,dri:40,def_:82,phy:67},
  ...
  {name:'Michael Olise',role:'RW',flag:'🇫🇷',club:'Bayern Munich',pos:'FW',age:23,stat:'Bundesliga champion 2025',rating:86,pac:87,sho:81,pas:76,dri:86,def_:40,phy:64},
  ...
  {name:'Rayan Cherki',role:'LW',flag:'🇫🇷',club:'Liverpool',pos:'FW',age:21,stat:'France golden boy 2025',rating:84,pac:85,sho:79,pas:74,dri:84,def_:40,phy:62},
  {name:'Warren Zaire-Emery',flag:'🇫🇷',club:'PSG',pos:'MF',age:19,stat:'Plus jeune buteur PSG',rating:84,pac:76,sho:69,pas:85,dri:78,def_:64,phy:70},
  {name:'Mathys Tel',role:'LW',flag:'🇫🇷',club:'Bayern Munich',pos:'FW',age:20,stat:'Bundesliga 2025',rating:82,pac:83,sho:77,pas:72,dri:82,def_:40,phy:60},
    {name:'Endrick',role:'CF',flag:'🇧🇷',club:'Real Madrid',pos:'FW',age:18,stat:'Brazil youngest scorer',rating:83,pac:80,sho:84,pas:71,dri:78,def_:40,phy:65},
  {name:'Alejandro Garnacho',role:'LW',flag:'🇦🇷',club:'Man. Utd',pos:'FW',age:21,stat:'Argentina WC 2026',rating:83,pac:84,sho:78,pas:73,dri:83,def_:40,phy:61},
  {name:'Heorhiy Sudakov',flag:'🇺🇦',club:'Shakhtar',pos:'MF',age:22,stat:'Ukraine captain',rating:82,pac:74,sho:67,pas:83,dri:76,def_:62,phy:68},
  {name:'Evan Ferguson',flag:'🇮🇪',club:'Brighton',pos:'FW',age:21,stat:'Ireland No.9',rating:81,pac:79,sho:81,pas:71,dri:77,def_:40,phy:61}
];
...
function App(){
 ...
 e('nav',{style:{position:'sticky',top:0,zIndex:20,background:'rgba(6,9,26,0.97)',backdropFilter:'blur(14px)',borderBottom:'2px solid rgba(212,175,55,0.2)',overflowX:'auto',WebkitOverflowScrolling:'touch',scrollbarWidth:'none'}},
  e('div',{style:{display:'flex',gap:4,padding:'8px 10px',minWidth:'max-content'}},
