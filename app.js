...
var STARS = [
  // ── FORWARDS (FW) ────────────────────────────────────────────
  {name:'Kylian Mbappe',role:'LW',flag:'🇫🇷',club:'Real Madrid',pos:'FW',age:26,stat:'47 intl goals',rating:97},
  {name:'Erling Haaland',role:'CF',flag:'🇳🇴',club:'Man. City',pos:'FW',age:24,stat:'44 intl goals',rating:95},
  {name:'Vinicius Jr.',flag:'🇧🇷',club:'Real Madrid',pos:'FW',age:24,stat:'Ballon dOr nominee 2024',rating:94},
  {name:'Lionel Messi',flag:'🇦🇷',club:'Inter Miami',pos:'FW',age:37,stat:'8x Ballon dOr',rating:94},
  {name:'Lamine Yamal',role:'RW',flag:'🇪🇸',club:'FC Barcelona',pos:'FW',age:17,stat:'Euro 2024 champion',rating:91},
  {name:'Harry Kane',role:'CF',flag:'🏴󠁧󠁢󠁥󠁮󠁧󠁿',club:'Bayern Munich',pos:'FW',age:31,stat:'England top scorer',rating:91},
  {name:'Cristiano Ronaldo',role:'CF',flag:'🇵🇹',club:'Al Nassr',pos:'FW',age:40,stat:'915 career goals',rating:91},
  {name:'Bukayo Saka',role:'LW',flag:'🏴󠁧󠁢󠁥󠁮󠁧󠁿',club:'Arsenal',pos:'FW',age:23,stat:'PFA Young Player 2024',rating:89},
  {name:'Nico Williams',role:'RW',flag:'🇪🇸',club:'Athletic Bilbao',pos:'FW',age:21,stat:'Euro 2024 champion',rating:87},
  {name:'Lautaro Martinez',role:'CF',flag:'🇦🇷',club:'Inter Milan',pos:'FW',age:26,stat:'WC 2022 champion',rating:87},
  {name:'Marcus Thuram',role:'CF',flag:'🇫🇷',club:'Inter Milan',pos:'FW',age:26,stat:'Serie A champion 2024',rating:87},
    {name:'Raphinha',role:'LW',flag:'🇧🇷',club:'FC Barcelona',pos:'FW',age:28,stat:'Champions League 2025',rating:86},
  {name:'Robert Lewandowski',role:'CF',flag:'🇵🇱',club:'FC Barcelona',pos:'FW',age:36,stat:'5x top scorer',rating:86},
  {name:'Cody Gakpo',role:'LW',flag:'🇳🇱',club:'Liverpool',pos:'FW',age:25,stat:'WC 2022 top scorer NL',rating:85},
  {name:'Dusan Vlahovic',role:'CF',flag:'🇷🇸',club:'Juventus',pos:'FW',age:24,stat:'Serie A top scorer',rating:85},
  {name:'Romelu Lukaku',role:'CF',flag:'🇧🇪',club:'Napoli',pos:'FW',age:31,stat:'Belgium top scorer',rating:84},
  {name:'Jonathan David',role:'CF',flag:'🇨🇦',club:'Lille',pos:'FW',age:24,stat:'Ligue 1 top scorer 2024',rating:84},
  {name:'Alvaro Morata',flag:'🇪🇸',club:'AC Milan',pos:'FW',age:31,stat:'Euro 2024 champion',rating:84},
  {name:'Richarlison',role:'RW',flag:'🇧🇷',club:'Tottenham',pos:'FW',age:27,stat:'WC 2022 Brazil',rating:84},
  {name:'Sadio Mane',role:'LW',flag:'🇸🇳',club:'Al Nassr',pos:'FW',age:32,stat:'AFCON winner 2022',rating:84},
  {name:'Donyell Malen',role:'RW',flag:'🇳🇱',club:'Aston Villa',pos:'FW',age:26,stat:'Bundesliga top scorer 2023',rating:83},
  {name:'Memphis Depay',role:'LW',flag:'🇳🇱',club:'Atletico Madrid',pos:'FW',age:30,stat:'Dutch all-time top scorer',rating:83},
  {name:'Victor Boniface',role:'CF',flag:'🇳🇬',club:'Bayer Leverkusen',pos:'FW',age:23,stat:'Bundesliga champion 2024',rating:83},
  {name:'Rasmus Hojlund',role:'CF',flag:'🇩🇰',club:'Man. Utd',pos:'FW',age:22,stat:'Denmark top striker',rating:83},
  {name:'Santiago Gimenez',role:'CF',flag:'🇲🇽',club:'AC Milan',pos:'FW',age:23,stat:'Mexico WC 2026 host',rating:83},
  {name:'Ivan Toney',role:'CF',flag:'🏴󠁧󠁢󠁥󠁮󠁧󠁿',club:'Al-Ahli',pos:'FW',age:29,stat:'England squad 2024',rating:82},
    {name:'Evan Ferguson',role:'CF',flag:'🇮🇪',club:'Brighton',pos:'FW',age:20,stat:'Ireland rising star',rating:81},
  {name:'Youssoufa Moukoko',flag:'🇩🇪',club:'Nice',pos:'FW',age:20,stat:'Germany young star',rating:81},

  // ── MIDFIELDERS (MF) ─────────────────────────────────────────
  {name:'Rodri',flag:'🇪🇸',club:'Man. City',pos:'MF',age:28,stat:'Ballon dOr 2024',rating:93},
  {name:'Jude Bellingham',flag:'🏴󠁧󠁢󠁥󠁮󠁧󠁿',club:'Real Madrid',pos:'MF',age:21,stat:'Best player Euro 2024',rating:93},
  {name:'Pedri',flag:'🇪🇸',club:'FC Barcelona',pos:'MF',age:22,stat:'Euro 2024 champion',rating:92},
  {name:'Gavi',flag:'🇪🇸',club:'FC Barcelona',pos:'MF',age:20,stat:'Euro 2024 champion',rating:88},
  {name:'Federico Valverde',flag:'🇺🇾',club:'Real Madrid',pos:'MF',age:25,stat:'Copa America 2024',rating:88},
  {name:'Phil Foden',flag:'🏴󠁧󠁢󠁥󠁮󠁧󠁿',club:'Man. City',pos:'MF',age:24,stat:'PFA Player of Year 2024',rating:88},
  {name:'Martin Odegaard',flag:'🇳🇴',club:'Arsenal',pos:'MF',age:26,stat:'Arsenal captain',rating:88},
  {name:'Florian Wirtz',flag:'🇩🇪',club:'Bayer Leverkusen',pos:'MF',age:21,stat:'Bundesliga champion 2024',rating:87},
  {name:'Khvicha Kvaratskhelia',flag:'🇬🇪',club:'PSG',pos:'MF',age:23,stat:'Serie A best player 2023',rating:86},
  {name:'Declan Rice',flag:'🏴󠁧󠁢󠁥󠁮󠁧󠁿',club:'Arsenal',pos:'MF',age:25,stat:'PL Best midfielder 2024',rating:87},
  {name:'Bruno Fernandes',flag:'🇵🇹',club:'Man. Utd',pos:'MF',age:29,stat:'Man Utd captain',rating:86},
  {name:'Aurelien Tchouameni',flag:'🇫🇷',club:'Real Madrid',pos:'MF',age:24,stat:'WC 2022 finalist',rating:86},
  {name:'Frenkie de Jong',flag:'🇳🇱',club:'FC Barcelona',pos:'MF',age:27,stat:'UCL semi 2019',rating:86},
    {name:'Alexis Mac Allister',flag:'🇦🇷',club:'Liverpool',pos:'MF',age:25,stat:'WC 2022 champion',rating:85},
  {name:'Enzo Fernandez',flag:'🇦🇷',club:'Chelsea',pos:'MF',age:24,stat:'WC 2022 best young',rating:85},
  {name:'Eduardo Camavinga',flag:'🇫🇷',club:'Real Madrid',pos:'MF',age:21,stat:'UCL winner 2024',rating:85},
  {name:'Bernardo Silva',flag:'🇵🇹',club:'Man. City',pos:'MF',age:29,stat:'PL champion 2024',rating:86},
  {name:'Vitinha',flag:'🇵🇹',club:'PSG',pos:'MF',age:24,stat:'Portugal Euro 2024',rating:85},
  {name:'Ilkay Gundogan',flag:'🇩🇪',club:'FC Barcelona',pos:'MF',age:33,stat:'PL POTY 2023',rating:85},
  {name:'Granit Xhaka',flag:'🇨🇭',club:'Bayer Leverkusen',pos:'MF',age:31,stat:'Bundesliga champion 2024',rating:84},
  {name:'Luka Modric',flag:'🇭🇷',club:'Real Madrid',pos:'MF',age:39,stat:'WC 2022 finalist',rating:84},
  {name:'Exequiel Palacios',flag:'🇦🇷',club:'Bayer Leverkusen',pos:'MF',age:26,stat:'WC 2022 champion',rating:84},
  {name:'Dominik Szoboszlai',flag:'🇭🇺',club:'Liverpool',pos:'MF',age:24,stat:'Hungary captain',rating:84},
  {name:'Ryan Gravenberch',flag:'🇳🇱',club:'Liverpool',pos:'MF',age:22,stat:'PL best midfielder 2024',rating:84},
  {name:'Xavi Simons',flag:'🇳🇱',club:'Leipzig',pos:'MF',age:22,stat:'Bundesliga rising star',rating:83},
  {name:'Warren Zaire-Emery',flag:'🇫🇷',club:'PSG',pos:'MF',age:18,stat:'Youngest PSG scorer ever',rating:83},
  {name:'Sofyan Amrabat',flag:'🇲🇦',club:'Fiorentina',pos:'MF',age:28,stat:'WC 2022 best MF',rating:83},
    {name:'Youri Tielemans',flag:'🇧🇪',club:'Aston Villa',pos:'MF',age:27,stat:'Belgium Euro 2024',rating:83},

  // ── DEFENDERS (DF) ───────────────────────────────────────────
  {name:'Virgil van Dijk',flag:'🇳🇱',club:'Liverpool',pos:'DF',age:33,stat:'Best defender 2019',rating:89},
  {name:'Ruben Dias',flag:'🇵🇹',club:'Man. City',pos:'DF',age:27,stat:'PL Best defender 2021',rating:88},
  {name:'William Saliba',flag:'🇫🇷',club:'Arsenal',pos:'DF',age:23,stat:'Best young defender 2024',rating:87},
  {name:'Trent Alexander-Arnold',flag:'🏴󠁧󠁢󠁥󠁮󠁧󠁿',club:'Real Madrid',pos:'DF',age:26,stat:'UCL winner',rating:87},
  {name:'Josko Gvardiol',flag:'🇭🇷',club:'Man. City',pos:'DF',age:22,stat:'WC 2022 finalist',rating:87},
  {name:'Achraf Hakimi',flag:'🇲🇦',club:'PSG',pos:'DF',age:26,stat:'African best RB 2023',rating:87},
    {name:'Jules Kounde',flag:'🇫🇷',club:'FC Barcelona',pos:'DF',age:25,stat:'Euro 2024 finalist',rating:86},
  {name:'Theo Hernandez',flag:'🇫🇷',club:'AC Milan',pos:'DF',age:26,stat:'Serie A champion',rating:86},
  {name:'Marquinhos',flag:'🇧🇷',club:'PSG',pos:'DF',age:30,stat:'UCL finalist 2020',rating:86},
  {name:'Eder Militao',flag:'🇧🇷',club:'Real Madrid',pos:'DF',age:26,stat:'UCL winner 2022',rating:85},
  {name:'Dani Carvajal',flag:'🇪🇸',club:'Real Madrid',pos:'DF',age:32,stat:'UCL winner 2024',rating:85},
  {name:'Antonio Rudiger',flag:'🇩🇪',club:'Real Madrid',pos:'DF',age:31,stat:'UCL winner 2022',rating:85},
  {name:'Dayot Upamecano',flag:'🇫🇷',club:'Bayern Munich',pos:'DF',age:25,stat:'Euro 2024 finalist',rating:85},
  {name:'Min-jae Kim',flag:'🇰🇷',club:'Bayern Munich',pos:'DF',age:27,stat:'Best Asian defender',rating:85},
  {name:'Cristian Romero',flag:'🇦🇷',club:'Tottenham',pos:'DF',age:26,stat:'WC 2022 champion',rating:85},
  {name:'Alphonso Davies',flag:'🇨🇦',club:'Bayern Munich',pos:'DF',age:24,stat:'Canada WC 2026 host',rating:84},
  {name:'Nuno Mendes',flag:'🇵🇹',club:'PSG',pos:'DF',age:22,stat:'Euro 2024 Portugal',rating:84},
  {name:'Lisandro Martinez',flag:'🇦🇷',club:'Man. Utd',pos:'DF',age:26,stat:'WC 2022 champion',rating:84},
  {name:'Marc Cucurella',flag:'🇪🇸',club:'Chelsea',pos:'DF',age:25,stat:'Euro 2024 champion',rating:84},
  {name:'Andrew Robertson',flag:'🏴󠁧󠁢󠁳󠁣󠁴󠁿',club:'Liverpool',pos:'DF',age:31,stat:'UCL winner 2019',rating:84},
  {name:'Reece James',flag:'🏴󠁧󠁢󠁥󠁮󠁧󠁿',club:'Chelsea',pos:'DF',age:25,stat:'Chelsea captain',rating:84},
  {name:'Gleison Bremer',flag:'🇧🇷',club:'Juventus',pos:'DF',age:27,stat:'Serie A best defender',rating:84},
  {name:'Jeremie Frimpong',flag:'🇳🇱',club:'Bayer Leverkusen',pos:'DF',age:24,stat:'Bundesliga champion 2024',rating:83},
  {name:'Pedro Porro',flag:'🇪🇸',club:'Tottenham',pos:'DF',age:25,stat:'Euro 2024 champion',rating:83},
  {name:'Kyle Walker',flag:'🏴󠁧󠁢󠁥󠁮󠁧󠁿',club:'AC Milan',pos:'DF',age:34,stat:'PL champion x6',rating:83},
  {name:'Ben White',flag:'🏴󠁧󠁢󠁥󠁮󠁧󠁿',club:'Arsenal',pos:'DF',age:27,stat:'PL top defender 2024',rating:83},
  {name:'Kieran Trippier',flag:'🏴󠁧󠁢󠁥󠁮󠁧󠁿',club:'Newcastle',pos:'DF',age:34,stat:'PL best RB 2022',rating:83},
  {name:'Vanderson',flag:'🇧🇷',club:'Monaco',pos:'DF',age:23,stat:'Brazil right back',rating:82},
  
  // ── GOALKEEPERS (GK) ─────────────────────────────────────────
  {name:'Emiliano Martinez',flag:'🇦🇷',club:'Aston Villa',pos:'GK',age:32,stat:'WC 2022 Golden Glove',rating:89},
  {name:'Alisson Becker',flag:'🇧🇷',club:'Liverpool',pos:'GK',age:32,stat:'Best GK 2019',rating:88},
  {name:'Thibaut Courtois',flag:'🇧🇪',club:'Real Madrid',pos:'GK',age:32,stat:'UCL Best GK 2022',rating:88},
  {name:'Mike Maignan',flag:'🇫🇷',club:'AC Milan',pos:'GK',age:29,stat:'Euro 2024 GK',rating:87},
  {name:'Marc-Andre ter Stegen',flag:'🇩🇪',club:'FC Barcelona',pos:'GK',age:32,stat:'Best GK La Liga',rating:86},
  {name:'Diogo Costa',flag:'🇵🇹',club:'Porto',pos:'GK',age:25,stat:'Best GK UCL 2023',rating:86},
  {name:'David Raya',flag:'🇪🇸',club:'Arsenal',pos:'GK',age:29,stat:'PL Golden Glove 2024',rating:85},
  {name:'Manuel Neuer',flag:'🇩🇪',club:'Bayern Munich',pos:'GK',age:39,stat:'WC 2014 winner',rating:85},
  {name:'Yann Sommer',flag:'🇨🇭',club:'Inter Milan',pos:'GK',age:35,stat:'Serie A champion 2024',rating:84},
  {name:'Jordan Pickford',flag:'🏴󠁧󠁢󠁥󠁮󠁧󠁿',club:'Everton',pos:'GK',age:32,stat:'England No.1',rating:84},
  {name:'Gregor Kobel',flag:'🇨🇭',club:'Borussia Dortmund',pos:'GK',age:27,stat:'UCL finalist 2024',rating:84},
  {name:'Unai Simon',flag:'🇪🇸',club:'Athletic Bilbao',pos:'GK',age:27,stat:'Euro 2024 champion',rating:83},
  {name:'Andre Onana',flag:'🇨🇲',club:'Man. Utd',pos:'GK',age:28,stat:'UCL finalist 2023',rating:83},
  {name:'Gregor Kobel',flag:'🇨🇭',club:'Borussia Dortmund',pos:'GK',age:27,stat:'UCL finalist 2024',rating:84},
  {name:'Ibrahim Sehic',flag:'🇧🇦',club:'Rizespor',pos:'GK',age:33,stat:'Bosnia No.1',rating:80},
  // ── MORE FORWARDS ──
  {name:'Gabriel Jesus',role:'CF',flag:'🇧🇷',club:'Arsenal',pos:'FW',age:27,stat:'PL champion 2022',rating:83},
    {name:'Memphis Depay',flag:'🇳🇱',club:'Atletico Madrid',pos:'FW',age:30,stat:'Dutch top scorer',rating:83},
  {name:'Andre Silva',flag:'🇵🇹',club:'Leipzig',pos:'FW',age:29,stat:'Bundesliga top scorer 2021',rating:82},
  {name:'Breel Embolo',role:'CF',flag:'🇨🇭',club:'Monaco',pos:'FW',age:27,stat:'Switzerland captain',rating:82},
  {name:'Darwin Nunez',role:'CF',flag:'🇺🇾',club:'Liverpool',pos:'FW',age:25,stat:'Copa America 2024',rating:84},
  {name:'Hwang Hee-chan',role:'RW',flag:'🇰🇷',club:'Wolves',pos:'FW',age:28,stat:'South Korea No.9',rating:82},
  {name:'Ferran Torres',role:'LW',flag:'🇪🇸',club:'FC Barcelona',pos:'FW',age:24,stat:'Euro 2024 champion',rating:83},
  {name:'Ansu Fati',role:'RW',flag:'🇪🇸',club:'FC Barcelona',pos:'FW',age:22,stat:'Spain young star',rating:82},
  {name:'Kaoru Mitoma',role:'RW',flag:'🇯🇵',club:'Brighton',pos:'FW',age:27,stat:'Japan best player',rating:83},

  // ── MORE MIDFIELDERS ──
  {name:'Kai Havertz',flag:'🇩🇪',club:'Arsenal',pos:'MF',age:25,stat:'UCL winner 2021',rating:84},
  {name:'Mason Mount',flag:'🏴󠁧󠁢󠁥󠁮󠁧󠁿',club:'Man. Utd',pos:'MF',age:26,stat:'UCL winner 2021',rating:82},
  {name:'Leandro Paredes',flag:'🇦🇷',club:'Roma',pos:'MF',age:30,stat:'WC 2022 champion',rating:82},
  {name:'Rodrigo De Paul',flag:'🇦🇷',club:'Atletico Madrid',pos:'MF',age:30,stat:'WC 2022 champion',rating:83},
  {name:'Yusuf Yazici',flag:'🇹🇷',club:'Lille',pos:'MF',age:27,stat:'Turkey Euro 2024',rating:81},
  {name:'Piotr Zielinski',flag:'🇵🇱',club:'Inter Milan',pos:'MF',age:30,stat:'Serie A champion 2024',rating:83},
  {name:'Mateus Fernandes',flag:'🇵🇹',club:'Southampton',pos:'MF',age:21,stat:'Portugal rising star',rating:81},
  {name:'Tijjani Reijnders',flag:'🇳🇱',club:'AC Milan',pos:'MF',age:26,stat:'Serie A best MF 2024',rating:84},
  {name:'Joao Neves',flag:'🇵🇹',club:'PSG',pos:'MF',age:20,stat:'Portugal golden boy',rating:84},
  {name:'Gabri Veiga',flag:'🇪🇸',club:'Al-Qadsiah',pos:'MF',age:22,stat:'Spain U21 champion',rating:81},

  // ── MORE DEFENDERS ──
  {name:'Jordi Alba',flag:'🇪🇸',club:'Inter Miami',pos:'DF',age:35,stat:'Euro 2012/2024 winner',rating:80},
  {name:'Presnel Kimpembe',flag:'🇫🇷',club:'PSG',pos:'DF',age:28,stat:'France squad',rating:82},
  {name:'Ibrahima Konate',flag:'🇫🇷',club:'Liverpool',pos:'DF',age:25,stat:'UCL winner 2022',rating:85},
  {name:'Pau Cubarsi',flag:'🇪🇸',club:'FC Barcelona',pos:'DF',age:17,stat:'Euro 2024 youngest DF',rating:83},
  {name:'Levi Colwill',flag:'🏴󠁧󠁢󠁥󠁮󠁧󠁿',club:'Chelsea',pos:'DF',age:22,stat:'England U21 captain',rating:82},
  {name:'Ezri Konsa',flag:'🏴󠁧󠁢󠁥󠁮󠁧󠁿',club:'Aston Villa',pos:'DF',age:27,stat:'PL best defender 2024',rating:83},
  {name:'Micky van de Ven',flag:'🇳🇱',club:'Tottenham',pos:'DF',age:23,stat:'PL fastest player',rating:83},
  {name:'Fabian Schar',flag:'🇨🇭',club:'Newcastle',pos:'DF',age:32,stat:'Switzerland captain',rating:82},
  {name:'Rayan Ait-Nouri',flag:'🇩🇿',club:'Wolves',pos:'DF',age:23,stat:'Algeria No.1 LB',rating:82},
  {name:'Nuno Tavares',flag:'🇵🇹',club:'Lazio',pos:'DF',age:24,stat:'Portugal squad 2024',rating:81},

  // ── MORE GOALKEEPERS ──
  {name:'Raya David',flag:'🇪🇸',club:'Arsenal',pos:'GK',age:29,stat:'PL Golden Glove 2024',rating:85},
  {name:'Matz Sels',flag:'🇧🇪',club:'Nottm Forest',pos:'GK',age:32,stat:'Belgium No.1',rating:82},
  {name:'Predrag Rajkovic',flag:'🇷🇸',club:'Atletico Madrid',pos:'GK',age:30,stat:'Serbia No.1',rating:82},
  {name:'Bono',flag:'🇲🇦',club:'Al-Qadsiah',pos:'GK',age:33,stat:'Morocco WC 2022 hero',rating:83},
  {name:'Lukasz Fabianski',flag:'🇵🇱',club:'West Ham',pos:'GK',age:39,stat:'Poland veteran',rating:80},
  // ── EXTRA FORWARDS (target 50 FW) ──
  {name:'Richarlison',flag:'🇧🇷',club:'Tottenham',pos:'FW',age:27,stat:'WC 2022 Brazil',rating:84},
  {name:'Gabriel Martinelli',role:'LW',flag:'🇧🇷',club:'Arsenal',pos:'FW',age:23,stat:'PL top scorer 2024',rating:84},
  {name:'Pedro',role:'CF',flag:'🇧🇷',club:'Flamengo',pos:'FW',age:27,stat:'Copa Libertadores winner',rating:83},
  {name:'Neymar Jr',role:'CF',flag:'🇧🇷',club:'Al-Hilal',pos:'FW',age:33,stat:'Brazil record scorer',rating:85},
    {name:'Ollie Watkins',role:'CF',flag:'🏴󠁧󠁢󠁥󠁮󠁧󠁿',club:'Aston Villa',pos:'FW',age:29,stat:'PL top scorer 2024',rating:84},
  {name:'Darwin Nunez',flag:'🇺🇾',club:'Liverpool',pos:'FW',age:25,stat:'Copa America 2024',rating:84},
  {name:'Ferran Torres',flag:'🇪🇸',club:'FC Barcelona',pos:'FW',age:24,stat:'Euro 2024 champion',rating:83},
  {name:'Kaoru Mitoma',flag:'🇯🇵',club:'Brighton',pos:'FW',age:27,stat:'Japan best player',rating:83},
  {name:'Hwang Hee-chan',flag:'🇰🇷',club:'Wolves',pos:'FW',age:28,stat:'South Korea No.9',rating:82},
  {name:'Gabriel Jesus',flag:'🇧🇷',club:'Arsenal',pos:'FW',age:27,stat:'PL champion 2022',rating:83},
  {name:'Breel Embolo',flag:'🇨🇭',club:'Monaco',pos:'FW',age:27,stat:'Switzerland striker',rating:82},
  {name:'Andre Silva',flag:'🇵🇹',club:'Leipzig',pos:'FW',age:29,stat:'Bundesliga top scorer 2021',rating:82},
  {name:'Patrik Schick',role:'CF',flag:'🇨🇿',club:'Bayer Leverkusen',pos:'FW',age:29,stat:'Euro 2020 top scorer',rating:83},
  {name:'Edin Dzeko',flag:'🇧🇦',club:'Fenerbahce',pos:'FW',age:38,stat:'Bosnia legend',rating:80},
    {name:'Teemu Pukki',flag:'🇫🇮',club:'Celtic',pos:'FW',age:34,stat:'Finland captain',rating:80},
  {name:'Timo Werner',role:'CF',flag:'🇩🇪',club:'Tottenham',pos:'FW',age:28,stat:'Germany Euro 2024',rating:82},
  {name:'Serhou Guirassy',role:'CF',flag:'🇬🇳',club:'Borussia Dortmund',pos:'FW',age:28,stat:'Bundesliga top scorer 2024',rating:84},
  {name:'Che Adams',flag:'🏴󠁧󠁢󠁳󠁣󠁴󠁿',club:'Torino',pos:'FW',age:28,stat:'Scotland top scorer',rating:81},
  {name:'Jonathan Burkardt',flag:'🇩🇪',club:'Mainz',pos:'FW',age:24,stat:'Germany U21',rating:81},
  {name:'Loic Mbe Soh',flag:'🇨🇲',club:'Nottm Forest',pos:'FW',age:23,stat:'Cameroon rising star',rating:80},
  {name:'Mohamed Salah',role:'RW',flag:'🇪🇬',club:'Liverpool',pos:'FW',age:32,stat:'Egypt legend',rating:88},
  {name:'Sadio Mane',flag:'🇸🇳',club:'Al Nassr',pos:'FW',age:32,stat:'AFCON winner 2022',rating:84},
  {name:'Riyad Mahrez',role:'LW',flag:'🇩🇿',club:'Al Ahli',pos:'FW',age:33,stat:'Algeria captain',rating:84},

  // ── EXTRA MIDFIELDERS (target 50 MF) ──
  {name:'Kai Havertz',flag:'🇩🇪',club:'Arsenal',pos:'MF',age:25,stat:'UCL winner 2021',rating:84},
  {name:'Leandro Paredes',flag:'🇦🇷',club:'Roma',pos:'MF',age:30,stat:'WC 2022 champion',rating:82},
  {name:'Rodrigo De Paul',flag:'🇦🇷',club:'Atletico Madrid',pos:'MF',age:30,stat:'WC 2022 champion',rating:83},
  {name:'Tijjani Reijnders',flag:'🇳🇱',club:'AC Milan',pos:'MF',age:26,stat:'Serie A best MF 2024',rating:84},
  ...
  {name:'Mason Mount',flag:'🏴󠁧󠁢󠁥󠁮󠁧󠁿',club:'Man. Utd',pos:'MF',age:26,stat:'UCL winner 2021',rating:82},
  {name:'Yusuf Yazici',flag:'🇹🇷',club:'Lille',pos:'MF',age:27,stat:'Turkey Euro 2024',rating:81},
  {name:'James Maddison',flag:'🏴󠁧󠁢󠁥󠁮󠁧󠁿',club:'Tottenham',pos:'MF',age:28,stat:'PL best creative 2024',rating:84},
  {name:'Bruno Guimaraes',flag:'🇧🇷',club:'Newcastle',pos:'MF',age:26,stat:'Brazil WC 2026',rating:85},
  {name:'Mateus Fernandes',flag:'🇵🇹',club:'Southampton',pos:'MF',age:21,stat:'Portugal rising star',rating:81},
  {name:'Gabri Veiga',flag:'🇪🇸',club:'Al-Qadsiah',pos:'MF',age:22,stat:'Spain U21',rating:81},
      {name:'Thomas Partey',flag:'🇬🇭',club:'Arsenal',pos:'MF',age:31,stat:'Ghana captain',rating:83},
  {name:'Ruben Neves',flag:'🇵🇹',club:'Al Hilal',pos:'MF',age:27,stat:'Portugal squad',rating:83},
  {name:'Conor Gallagher',flag:'🏴󠁧󠁢󠁥󠁮󠁧󠁿',club:'Atletico Madrid',pos:'MF',age:24,stat:'England Euro 2024',rating:82},
  {name:'Matias Vecino',flag:'🇺🇾',club:'Lazio',pos:'MF',age:33,stat:'Uruguay captain',rating:81},
  {name:'Teun Koopmeiners',flag:'🇳🇱',club:'Juventus',pos:'MF',age:26,stat:'Netherlands Euro 2024',rating:85},
  {name:'Sandro Tonali',flag:'🇮🇹',club:'Newcastle',pos:'MF',age:24,stat:'Serie A champion 2022',rating:83},
  {name:'Przemyslaw Frankowski',flag:'🇵🇱',club:'Lens',pos:'MF',age:29,stat:'Poland wing',rating:81},
  {name:'Ivan Ilic',flag:'🇷🇸',club:'Torino',pos:'MF',age:23,stat:'Serbia rising star',rating:81},
  {name:'Kevin De Bruyne',flag:'🇧🇪',club:'Man. City',pos:'MF',age:33,stat:'PL best midfielder',rating:91},
    {name:'N Golo Kante',flag:'🇫🇷',club:'Al Ittihad',pos:'MF',age:33,stat:'WC 2018 winner',rating:85},

  // ── EXTRA DEFENDERS (target 50 DF) ──
  {name:'Ibrahima Konate',flag:'🇫🇷',club:'Liverpool',pos:'DF',age:25,stat:'UCL winner 2022',rating:85},
  {name:'Pau Cubarsi',flag:'🇪🇸',club:'FC Barcelona',pos:'DF',age:17,stat:'Euro 2024 youngest DF',rating:83},
  {name:'Levi Colwill',flag:'🏴󠁧󠁢󠁥󠁮󠁧󠁿',club:'Chelsea',pos:'DF',age:22,stat:'England U21 captain',rating:82},
  {name:'Ezri Konsa',flag:'🏴󠁧󠁢󠁥󠁮󠁧󠁿',club:'Aston Villa',pos:'DF',age:27,stat:'PL best defender 2024',rating:83},
  {name:'Micky van de Ven',flag:'🇳🇱',club:'Tottenham',pos:'DF',age:23,stat:'PL fastest player',rating:83},
  {name:'Fabian Schar',flag:'🇨🇭',club:'Newcastle',pos:'DF',age:32,stat:'Switzerland captain',rating:82},
  {name:'Rayan Ait-Nouri',flag:'🇩🇿',club:'Wolves',pos:'DF',age:23,stat:'Algeria LB',rating:82},
  {name:'Nuno Tavares',flag:'🇵🇹',club:'Lazio',pos:'DF',age:24,stat:'Portugal squad',rating:81},
  {name:'Jonathan Tah',flag:'🇩🇪',club:'Bayern Munich',pos:'DF',age:28,stat:'Germany Euro 2024',rating:83},
  {name:'Piero Hincapie',flag:'🇪🇨',club:'Bayer Leverkusen',pos:'DF',age:23,stat:'Bundesliga champion',rating:83},
  {name:'Edmond Tapsoba',flag:'🇧🇫',club:'Bayer Leverkusen',pos:'DF',age:25,stat:'Bundesliga champion',rating:82},
  {name:'Nordi Mukiele',flag:'🇫🇷',club:'PSG',pos:'DF',age:26,stat:'France squad',rating:82},
  {name:'Malo Gusto',flag:'🇫🇷',club:'Chelsea',pos:'DF',age:22,stat:'France U21 champion',rating:82},
  {name:'Pervis Estupinan',flag:'🇪🇨',club:'Brighton',pos:'DF',age:26,stat:'Ecuador No.1 LB',rating:82},
  {name:'Konstantinos Tsimikas',flag:'🇬🇷',club:'Liverpool',pos:'DF',age:28,stat:'Greece captain',rating:82},
  {name:'Ferdi Kadioglu',flag:'🇹🇷',club:'Brighton',pos:'DF',age:25,stat:'Turkey Euro 2024',rating:83},
  {name:'Jeremie Frimpong',flag:'🇳🇱',club:'Bayer Leverkusen',pos:'DF',age:24,stat:'Bundesliga champion',rating:83},
  {name:'Vanderson',flag:'🇧🇷',club:'Monaco',pos:'DF',age:23,stat:'Brazil right back',rating:82},
  {name:'Destiny Udogie',flag:'🇮🇹',club:'Tottenham',pos:'DF',age:22,stat:'Italy Euro 2024',rating:82},
  {name:'Theo Hernandez',flag:'🇫🇷',club:'AC Milan',pos:'DF',age:27,stat:'Serie A champion',rating:86},
  {name:'Stefan de Vrij',flag:'🇳🇱',club:'Inter Milan',pos:'DF',age:32,stat:'Serie A champion 2024',rating:84},
  {name:'Danilo',flag:'🇧🇷',club:'Juventus',pos:'DF',age:33,stat:'Brazil captain',rating:83},
  {name:'Cesar Azpilicueta',flag:'🇪🇸',club:'Atletico Madrid',pos:'DF',age:34,stat:'Euro 2024 champion',rating:81},
  {name:'Youcef Atal',flag:'🇩🇿',club:'Nice',pos:'DF',age:28,stat:'Algeria No.1 RB',rating:81},
  {name:'Hamari Traore',flag:'🇲🇱',club:'Rennes',pos:'DF',age:30,stat:'Mali captain',rating:81},

  // ── EXTRA GOALKEEPERS (target 25 GK) ──
  {name:'Raya David',flag:'🇪🇸',club:'Arsenal',pos:'GK',age:29,stat:'PL Golden Glove 2024',rating:85},
  {name:'Matz Sels',flag:'🇧🇪',club:'Nottm Forest',pos:'GK',age:32,stat:'Belgium No.1',rating:82},
  {name:'Predrag Rajkovic',flag:'🇷🇸',club:'Atletico Madrid',pos:'GK',age:30,stat:'Serbia No.1',rating:82},
  {name:'Bono',flag:'🇲🇦',club:'Al-Qadsiah',pos:'GK',age:33,stat:'Morocco WC 2022 hero',rating:83},
  {name:'Lukasz Fabianski',flag:'🇵🇱',club:'West Ham',pos:'GK',age:39,stat:'Poland veteran',rating:80},
  {name:'Caoimhin Kelleher',flag:'🇮🇪',club:'Liverpool',pos:'GK',age:25,stat:'Ireland No.1',rating:82},
  {name:'Dean Henderson',flag:'🏴󠁧󠁢󠁥󠁮󠁧󠁿',club:'Crystal Palace',pos:'GK',age:27,stat:'England squad',rating:82},
  {name:'Giorgi Mamardashvili',flag:'🇬🇪',club:'Liverpool',pos:'GK',age:23,stat:'Georgia hero Euro 2024',rating:84},
  {name:'Filip Jorgensen',flag:'🇩🇰',club:'Chelsea',pos:'GK',age:22,stat:'Denmark rising star',rating:82},
  {name:'Altay Bayindir',flag:'🇹🇷',club:'Man. Utd',pos:'GK',age:26,stat:'Turkey Euro 2024',rating:81},
  // ── NOUVEAUX JOUEURS 2026 ──
  {name:'Michael Olise',role:'RW',flag:'🇫🇷',club:'Bayern Munich',pos:'FW',age:23,stat:'Bundesliga champion 2025',rating:86},
  {name:'Desire Doue',role:'LW',flag:'🇫🇷',club:'PSG',pos:'FW',age:20,stat:'France espoir 2024',rating:84},
  {name:'Rayan Cherki',role:'LW',flag:'🇫🇷',club:'Liverpool',pos:'FW',age:21,stat:'France golden boy 2025',rating:84},
  {name:'Warren Zaire-Emery',flag:'🇫🇷',club:'PSG',pos:'MF',age:19,stat:'Plus jeune buteur PSG',rating:84},
  {name:'Mathys Tel',role:'LW',flag:'🇫🇷',club:'Bayern Munich',pos:'FW',age:20,stat:'Bundesliga 2025',rating:82},
    {name:'Endrick',role:'CF',flag:'🇧🇷',club:'Real Madrid',pos:'FW',age:18,stat:'Brazil youngest scorer',rating:83},
  {name:'Alejandro Garnacho',role:'LW',flag:'🇦🇷',club:'Man. Utd',pos:'FW',age:21,stat:'Argentina WC 2026',rating:83},
  {name:'Heorhiy Sudakov',flag:'🇺🇦',club:'Shakhtar',pos:'MF',age:22,stat:'Ukraine captain',rating:82},
  {name:'Evan Ferguson',flag:'🇮🇪',club:'Brighton',pos:'FW',age:21,stat:'Ireland No.9',rating:81}
];
        ...
        e('div',{style:{background:'linear-gradient(180deg,#1a5c1a,#2d8a2d)',borderRadius:14,padding:'12px 8px',marginBottom:12,position:'relative'}},
          ...
          e('div',{style:{display:'flex',justifyContent:'space-around',marginBottom:10}},
            ['LW','CF','RW'].map(function(pos){
              var pl=fantasyTeam.find(function(p){return (p.role===pos)||(p.pos==='FW'&&!p.role&&p.pos===pos);});
          ...
          e('div',{style:{display:'flex',justifyContent:'space-around',marginBottom:10}},
            ['LM','CM','RM'].map(function(pos){
              ...
              var mfPlayers=fantasyTeam.filter(function(p){return p.pos==='MF';});
              var pl=mfPlayers[subMap[pos]];
              return e('div',{key:pos,onClick:function(){if(!fantasyDone)setFantasyPos(pos);},style:{textAlign:'center',cursor:'pointer'}},
