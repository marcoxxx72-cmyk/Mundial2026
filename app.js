...
function App(){
  ...
  function runSimulation(){
    ...
    var prompt='You are a football expert. Analyze this World Cup 2026 match simulation result and give a brief 3-sentence tactical analysis in '+lang+' language. Match: '+simTeam1+' '+g1+' - '+g2+' '+simTeam2+'. Team strengths: '+simTeam1+'='+s1+'/100, '+simTeam2+'='+s2+'/100. Possession: '+poss1+'% vs '+poss2+'%. Shots: '+shots1+' vs '+shots2+'. Be concise and insightful.';
