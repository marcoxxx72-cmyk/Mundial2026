...
var T = {
  en:{appTitle:'World Cup 2026',appSub:'USA - CANADA - MEXICO',nav:['Home','Groups','Predictions','Quiz','Stars','Polls'],countdown:'Countdown',timeUnits:['Days','Hours','Min','Sec'],keyInfo:['Host nations','Teams','Matches','Duration'],keyVals:['3 nations','48 teams','104 matches','Jun 11-Jul 19'],format:'Tournament Format',formatLines:['12 groups of 4 teams','1st + 2nd + 8 best 3rds = 32 teams','Round of 32 > 16 > QF > SF > Final','Opening: Estadio Azteca, Mexico City','Final: MetLife Stadium, New York'],groupsTitle:'48 TEAMS - 12 GROUPS',hostLabel:'Host',groupLabel:'Group',pronoSub:'Who will reach the final?',pronoWinner:'World Champion 2026',pronoFinal:'Runner-up',pronoSemi:'Semi-finalists',pronoSave:'Save',pronoSaved:'Saved!',pronoReset:'Reset',pronoChoose:'Choose...',pronoMyPick:'My pick',quizSub:'Test your knowledge!',quizScore:'Score',quizNext:'Next question',quizFinish:'See result',quizRestart:'Play again',quizPerfect:'PERFECT! You are an expert!',quizGood:'Great job!',quizAvg:'Not bad!',quizBad:'Keep studying!',starsSub:'Players to watch',pollTitle:'Polls',pollTotal:'votes',didYouKnow:'Did you know?',facts:['Italy miss the 2026 World Cup for 2nd time','Azteca hosts its 3rd World Cup','First-ever 48-team World Cup','First edition co-hosted by 3 countries','104 matches vs 64 in 2022','New IFAB rules in effect'],bleus:'Les Bleus - Group I',bleusNote:'Deschamps final tournament as France manager',shareApp:'Share',shareCopied:'Link copied!',premiumBanner:'Go PREMIUM - Predictions + Stats + No ads',premiumBtn:'Unlock'},
  fr:{appTitle:'Mundial 2026',appSub:'ETATS-UNIS - CANADA - MEXIQUE',nav:['Accueil','Groupes','Pronostics','Quiz','Stars','Sondages'],countdown:'Compte a rebours',timeUnits:['Jours','Heures','Min','Sec'],keyInfo:['Pays hotes','Equipes','Matchs','Duree'],keyVals:['3 nations','48 equipes','104 matchs','11 juin-19 juil.'],format:'Format du tournoi',formatLines:['12 groupes de 4 equipes','1er + 2e + 8 meilleurs 3es = 32 equipes','Tour des 32 > 16e > QF > SF > Finale','Ouverture: Estadio Azteca, Mexico','Finale: MetLife Stadium, New York'],groupsTitle:'48 EQUIPES - 12 GROUPES',hostLabel:'Pays hote',groupLabel:'Groupe',pronoSub:'Qui ira en finale?',pronoWinner:'Champion du Monde 2026',pronoFinal:'Finaliste',pronoSemi:'Demi-finales',pronoSave:'Sauvegarder',pronoSaved:'Sauvegarde!',pronoReset:'Reinitialiser',pronoChoose:'Choisir...',pronoMyPick:'Mon choix',quizSub:'Testez vos connaissances!',quizScore:'Score',quizNext:'Question suivante',quizFinish:'Voir mon resultat',quizRestart:'Rejouer',quizPerfect:'PARFAIT! Tu es un expert!',quizGood:'Tres bien!',quizAvg:'Pas mal!',quizBad:'Continue a reviser!',starsSub:'Les joueurs a suivre',pollTitle:'Sondages',pollTotal:'votes',didYouKnow:'Le saviez-vous?',facts:['L Italie rate le Mondial 2026 pour la 2e fois','L Azteca accueille son 3e Mondial','1er Mondial a 48 equipes','1ere edition co-organisee par 3 pays','104 matchs contre 64 en 2022','Nouvelles regles IFAB effectives'],bleus:'Les Bleus - Groupe I',bleusNote:'Derniere competition de Deschamps sur le banc',shareApp:'Partager',shareCopied:'Lien copie!',premiumBanner:'Passez PREMIUM - Pronostics + Stats + Sans pub',premiumBtn:'Debloquer'},
  es:{appTitle:'Mundial 2026',appSub:'EE.UU. - CANADA - MEXICO',nav:['Inicio','Grupos','Pronosticos','Quiz','Estrellas','Sondeos'],countdown:'Cuenta regresiva',timeUnits:['Dias','Horas','Min','Seg'],keyInfo:['Paises anfitriones','Equipos','Partidos','Duracion'],keyVals:['3 naciones','48 equipos','104 partidos','11 jun-19 jul'],format:'Formato del torneo',formatLines:['12 grupos de 4 equipos','1 + 2 + 8 mejores 3eros = 32 equipos','Ronda de 32 > 16avos > QF > SF > Final','Apertura: Estadio Azteca, Mexico','Final: MetLife Stadium, Nueva York'],groupsTitle:'48 EQUIPOS - 12 GRUPOS',hostLabel:'Anfitri',groupLabel:'Grupo',pronoSub:'Quien llegara a la final?',pronoWinner:'Campeon del Mundo 2026',pronoFinal:'Finalista',pronoSemi:'Semifinalistas',pronoSave:'Guardar',pronoSaved:'Guardado!',pronoReset:'Reiniciar',pronoChoose:'Elegir...',pronoMyPick:'Mi eleccion',quizSub:'Pon a prueba tus conocimientos!',quizScore:'Puntuacion',quizNext:'Siguiente',quizFinish:'Ver resultado',quizRestart:'Jugar de nuevo',quizPerfect:'Perfecto! Eres un experto!',quizGood:'Muy bien!',quizAvg:'Nada mal!',quizBad:'Sigue estudiando!',starsSub:'Jugadores a seguir',pollTitle:'Sondeos',pollTotal:'votos',didYouKnow:'Sabias que?',facts:['Italia se pierde el Mundial 2026 por 2a vez','El Azteca acoge su 3er Mundial','El primer Mundial con 48 equipos','Primera edicion organizada por 3 paises','104 partidos frente a 64 en 2022','Nuevas reglas del IFAB en vigor'],bleus:'Les Bleus - Grupo I',bleusNote:'Ultimo torneo de Deschamps como seleccionador',shareApp:'Compartir',shareCopied:'Enlace copiado!',premiumBanner:'Hazte PREMIUM - Pronosticos + Estadisticas + Sin anuncios',premiumBtn:'Desbloquear'},
  pt:{appTitle:'Mundial 2026',appSub:'EUA - CANADA - MEXICO',nav:['Inicio','Grupos','Palpites','Quiz','Estrelas','Enquetes'],countdown:'Contagem regressiva',timeUnits:['Dias','Horas','Min','Seg'],keyInfo:['Paises anfitrioes','Selecoes','Jogos','Duracao'],keyVals:['3 nacoes','48 selecoes','104 jogos','11 jun-19 jul'],format:'Formato do torneio',formatLines:['12 grupos de 4 selecoes','1 + 2 + 8 melhores 3eiros = 32 equipes','Rodada de 32 > 16 > QF > SF > Final','Abertura: Estadio Azteca, Mexico','Final: MetLife Stadium, Nova York'],groupsTitle:'48 SELECOES - 12 GRUPOS',hostLabel:'Anfitriao',groupLabel:'Grupo',pronoSub:'Quem vai chegar a final?',pronoWinner:'Campeao do Mundo 2026',pronoFinal:'Vice-campeao',pronoSemi:'Semifinalistas',pronoSave:'Salvar',pronoSaved:'Salvo!',pronoReset:'Reiniciar',pronoChoose:'Escolher...',pronoMyPick:'Minha escolha',quizSub:'Teste seus conhecimentos!',quizScore:'Pontuacao',quizNext:'Proxima',quizFinish:'Ver resultado',quizRestart:'Jogar novamente',quizPerfect:'Perfeito! Voce e um expert!',quizGood:'Muito bem!',quizAvg:'Nada mal!',quizBad:'Continue estudando!',starsSub:'Jogadores para acompanhar',pollTitle:'Enquetes',pollTotal:'votos',didYouKnow:'Voce sabia?',facts:['A Italia perde a Copa 2026 pela 2a vez','O Azteca sedia sua 3a Copa','Primeira Copa com 48 selecoes','Primeira edicao organizada por 3 paises','104 jogos contra 64 em 2022','Novas regras do IFAB em vigor'],bleus:'Les Bleus - Grupo I',bleusNote:'Ultima competicao de Deschamps como tecnico',shareApp:'Compartilhar',shareCopied:'Link copiado!',premiumBanner:'Seja PREMIUM - Palpites + Estatisticas + Sem anuncios',premiumBtn:'Desbloquear'},
  it:{appTitle:'Mondiale 2026',appSub:'USA - CANADA - MESSICO',nav:['Home','Gruppi','Pronostici','Quiz','Stelle','Sondaggi'],countdown:'Conto alla rovescia',timeUnits:['Giorni','Ore','Min','Sec'],keyInfo:['Paesi ospitanti','Squadre','Partite','Durata'],keyVals:['3 nazioni','48 squadre','104 partite','11 giu-19 lug'],format:'Formato del torneo',formatLines:['12 gironi da 4 squadre','1a + 2a + 8 migliori 3e = 32 squadre','Fase a 32 > 16 > QF > SF > Finale','Apertura: Estadio Azteca, Messico','Finale: MetLife Stadium, New York'],groupsTitle:'48 SQUADRE - 12 GIRONI',hostLabel:'Sede',groupLabel:'Girone',pronoSub:'Chi arrivera in finale?',pronoWinner:'Campione del Mondo 2026',pronoFinal:'Finalista',pronoSemi:'Semifinalisti',pronoSave:'Salva',pronoSaved:'Salvato!',pronoReset:'Azzera',pronoChoose:'Scegli...',pronoMyPick:'La mia scelta',quizSub:'Metti alla prova le tue conoscenze!',quizScore:'Punteggio',quizNext:'Domanda successiva',quizFinish:'Vedi risultato',quizRestart:'Gioca ancora',quizPerfect:'Perfetto! Sei un esperto!',quizGood:'Molto bene!',quizAvg:'Niente male!',quizBad:'Continua a studiare!',starsSub:'I giocatori da seguire',pollTitle:'Sondaggi',pollTotal:'voti',didYouKnow:'Lo sapevi?',facts:['L Italia non e al Mondiale 2026 per la 2a volta','L Azteca ospita il suo 3o Mondiale','Primo Mondiale con 48 squadre','Prima edizione co-organizzata da 3 paesi','104 partite contro 64 nel 2022','Nuove regole IFAB in vigore'],bleus:'Les Bleus - Girone I',bleusNote:'Ultima competizione di Deschamps come ct della Francia',shareApp:'Condividi',shareCopied:'Link copiato!',premiumBanner:'Diventa PREMIUM - Pronostici + Statistiche + Senza pub',premiumBtn:'Sblocca'},
  de:{appTitle:'WM 2026',appSub:'USA - KANADA - MEXIKO',nav:['Start','Gruppen','Tipps','Quiz','Stars','Umfragen'],countdown:'Countdown',timeUnits:['Tage','Stunden','Min','Sek'],keyInfo:['Gastgeberlaender','Teams','Spiele','Dauer'],keyVals:['3 Nationen','48 Teams','104 Spiele','11. Jun-19. Jul'],format:'Turnierformat',formatLines:['12 Gruppen mit je 4 Teams','1. + 2. + 8 beste 3. = 32 Teams','Runde der 32 > 16 > VF > HF > Finale','Eroeffnung: Estadio Azteca, Mexiko','Finale: MetLife Stadium, New York'],groupsTitle:'48 TEAMS - 12 GRUPPEN',hostLabel:'Gastgeber',groupLabel:'Gruppe',pronoSub:'Wer kommt ins Finale?',pronoWinner:'Weltmeister 2026',pronoFinal:'Finalist',pronoSemi:'Halbfinalisten',pronoSave:'Speichern',pronoSaved:'Gespeichert!',pronoReset:'Zuruecksetzen',pronoChoose:'Auswaehlen...',pronoMyPick:'Meine Wahl',quizSub:'Teste dein Wissen!',quizScore:'Punkte',quizNext:'Naechste Frage',quizFinish:'Ergebnis sehen',quizRestart:'Nochmal spielen',quizPerfect:'Perfekt! Du bist ein Experte!',quizGood:'Sehr gut!',quizAvg:'Nicht schlecht!',quizBad:'Weiter lernen!',starsSub:'Spieler zum Beobachten',pollTitle:'Umfragen',pollTotal:'Stimmen',didYouKnow:'Wusstest du?',facts:['Italien verpasst die WM 2026 zum 2. Mal','Das Azteca beherbergt seine 3. WM','Erste WM mit 48 Teams','Erste WM von 3 Laendern gemeinsam ausgerichtet','104 Spiele gegen 64 in 2022','Neue IFAB-Regeln in Kraft'],bleus:'Les Bleus - Gruppe I',bleusNote:'Letztes Turnier von Deschamps als Frankreich-Trainer',shareApp:'Teilen',shareCopied:'Link kopiert!',premiumBanner:'PREMIUM werden - Tipps + Statistiken + Werbefrei',premiumBtn:'Freischalten'}
};
...
var STARS = [
  {name:'Kylian Mbappe',flag:'FR',club:'Real Madrid',pos:'FW',age:27,stat:'46 intl goals',rating:96,group:'I'},
  {name:'Erling Haaland',flag:'NO',club:'Man. City',pos:'FW',age:25,stat:'44 intl goals',rating:95,group:'I'},
  {name:'Vinicius Jr.',flag:'BR',club:'Real Madrid',pos:'FW',age:25,stat:'Ballon dOr nominee 2024',rating:94,group:'C'},
  {name:'Pedri',flag:'ES',club:'FC Barcelona',pos:'MF',age:23,stat:'Euro 2024 champion',rating:93,group:'H'},
  {name:'Jude Bellingham',flag:'EN',club:'Real Madrid',pos:'MF',age:22,stat:'Best player Euro 2024',rating:93,group:'L'},
  {name:'Rodri',flag:'ES',club:'Man. City',pos:'MF',age:29,stat:'Ballon dOr 2024',rating:92,group:'H'},
  {name:'Lamine Yamal',flag:'ES',club:'FC Barcelona',pos:'FW',age:18,stat:'Euro 2024 champion',rating:92,group:'H'},
  {name:'Cristiano Ronaldo',flag:'PT',club:'Al Nassr',pos:'FW',age:41,stat:'915 career goals',rating:90,group:'K'}
];

var QUIZ = {
  en:[{q:'How many teams in the 2026 World Cup?',opts:['32','40','48','56'],a:2},{q:'Which stadium hosts the Final?',opts:['Azteca','AT&T Stadium','MetLife Stadium','SoFi Stadium'],a:2},{q:'Which country is NOT a host?',opts:['USA','Canada','Mexico','Brazil'],a:3},{q:'Which group is France in?',opts:['Group A','Group C','Group G','Group I'],a:3},{q:'Who won the 2024 Ballon dOr?',opts:['Mbappe','Bellingham','Rodri','Vinicius'],a:2},{q:'How many total matches?',opts:['64','80','96','104'],a:3},{q:'Which stadium hosts the opening match?',opts:['MetLife','Azteca','AT&T Stadium','BC Place'],a:1},{q:'Who is France manager?',opts:['Zidane','Deschamps','Blanc','Wenger'],a:1},{q:'Which country won the 2022 World Cup?',opts:['France','Brazil','Croatia','Argentina'],a:3},{q:'Which Norwegian player is a Group I star?',opts:['Odegaard','Haaland','Sorloth','King'],a:1}],
  ...
  es:[{q:'Cuantos equipos en el Mundial 2026?',opts:['32','40','48','56'],a:2},{q:'En que estadio se juega la final?',opts:['Azteca','AT&T Stadium','MetLife Stadium','SoFi Stadium'],a:2},{q:'Que pais NO es organizador?',opts:['EE.UU.','Canada','Mexico','Brasil'],a:3},{q:'En que grupo esta Francia?',opts:['Grupo A','Grupo C','Grupo G','Grupo I'],a:3},{q:'Quien gano el Balon de Oro 2024?',opts:['Mbappe','Bellingham','Rodri','Vinicius'],a:2},{q:'Cuantos partidos en total?',opts:['64','80','96','104'],a:3},{q:'Que estadio acoge el partido inaugural?',opts:['MetLife','Azteca','AT&T Stadium','BC Place'],a:1},{q:'Quien es el seleccionador de Francia?',opts:['Zidane','Deschamps','Blanc','Wenger'],a:1},{q:'Que pais gano el Mundial 2022?',opts:['Francia','Brasil','Croacia','Argentina'],a:3},{q:'Que jugador noruego es estrella del Grupo I?',opts:['Odegaard','Haaland','Sorloth','King'],a:1}],
  pt:[{q:'Quantas selecoes na Copa 2026?',opts:['32','40','48','56'],a:2},{q:'Em qual estadio e a final?',opts:['Azteca','AT&T Stadium','MetLife Stadium','SoFi Stadium'],a:2},{q:'Qual pais NAO e sede?',opts:['EUA','Canada','Mexico','Brasil'],a:3},{q:'Em qual grupo esta a Franca?',opts:['Grupo A','Grupo C','Grupo G','Grupo I'],a:3},{q:'Quem ganhou a Bola de Ouro 2024?',opts:['Mbappe','Bellingham','Rodri','Vinicius'],a:2},{q:'Quantos jogos no total?',opts:['64','80','96','104'],a:3},{q:'Qual estadio recebe a abertura?',opts:['MetLife','Azteca','AT&T Stadium','BC Place'],a:1},{q:'Quem e o tecnico da Franca?',opts:['Zidane','Deschamps','Blanc','Wenger'],a:1},{q:'Qual pais ganhou a Copa 2022?',opts:['Franca','Brasil','Croacia','Argentina'],a:3},{q:'Qual jogador noruegues e estrela do Grupo I?',opts:['Odegaard','Haaland','Sorloth','King'],a:1}],
  it:[{q:'Quante squadre al Mondiale 2026?',opts:['32','40','48','56'],a:2},{q:'In quale stadio si gioca la finale?',opts:['Azteca','AT&T Stadium','MetLife Stadium','SoFi Stadium'],a:2},{q:'Quale paese NON e organizzatore?',opts:['USA','Canada','Messico','Brasile'],a:3},{q:'In quale girone e la Francia?',opts:['Girone A','Girone C','Girone G','Girone I'],a:3},{q:'Chi ha vinto il Pallone d Or 2024?',opts:['Mbappe','Bellingham','Rodri','Vinicius'],a:2},{q:'Quante partite in totale?',opts:['64','80','96','104'],a:3},{q:'Quale stadio ospita la partita inaugurale?',opts:['MetLife','Azteca','AT&T Stadium','BC Place'],a:1},{q:'Chi e il ct della Francia?',opts:['Zidane','Deschamps','Blanc','Wenger'],a:1},{q:'Quale paese ha vinto il Mondiale 2022?',opts:['Francia','Brasile','Croazia','Argentina'],a:3},{q:'Quale giocatore norvegese e stella del Girone I?',opts:['Odegaard','Haaland','Sorloth','King'],a:1}],
  de:[{q:'Wie viele Teams nehmen an der WM 2026 teil?',opts:['32','40','48','56'],a:2},{q:'In welchem Stadion findet das Finale statt?',opts:['Azteca','AT&T Stadium','MetLife Stadium','SoFi Stadium'],a:2},{q:'Welches Land ist KEIN Gastgeber?',opts:['USA','Kanada','Mexiko','Brasilien'],a:3},{q:'In welcher Gruppe spielt Frankreich?',opts:['Gruppe A','Gruppe C','Gruppe G','Gruppe I'],a:3},{q:'Wer hat den Ballon d Or 2024 gewonnen?',opts:['Mbappe','Bellingham','Rodri','Vinicius'],a:2},{q:'Wie viele Spiele gibt es insgesamt?',opts:['64','80','96','104'],a:3},{q:'Welches Stadion eroffnet das Turnier?',opts:['MetLife','Azteca','AT&T Stadium','BC Place'],a:1},{q:'Wer ist Frankreichs Nationaltrainer?',opts:['Zidane','Deschamps','Blanc','Wenger'],a:1},{q:'Welches Land hat die WM 2022 gewonnen?',opts:['Frankreich','Brasilien','Kroatien','Argentinien'],a:3},{q:'Welcher norwegische Spieler ist ein Star der Gruppe I?',opts:['Odegaard','Haaland','Sorloth','King'],a:1}]
};

var POLLS = {
  en:[{id:'p1',q:'Who will be World Champion 2026?',opts:['France','Argentina','Spain','Brazil'],votes:[1240,1580,980,1100]},{id:'p2',q:'Who will be the best player?',opts:['Mbappe','Haaland','Vinicius','Bellingham'],votes:[2100,1300,980,760]},{id:'p3',q:'Will France get through Group I?',opts:['Yes 1st','Yes 2nd','No eliminated'],votes:[3200,800,150]}],
  fr:[{id:'p1',q:'Qui sera champion du Monde 2026?',opts:['France','Argentine','Espagne','Bresil'],votes:[1240,1580,980,1100]},{id:'p2',q:'Quel sera le meilleur joueur?',opts:['Mbappe','Haaland','Vinicius','Bellingham'],votes:[2100,1300,980,760]},{id:'p3',q:'La France passera-t-elle le groupe I?',opts:['Oui 1ere','Oui 2eme','Non eliminee'],votes:[3200,800,150]}],
  es:[{id:'p1',q:'Quien sera campeon del Mundo 2026?',opts:['Francia','Argentina','Espana','Brasil'],votes:[1240,1580,980,1100]},{id:'p2',q:'Quien sera el mejor jugador?',opts:['Mbappe','Haaland','Vinicius','Bellingham'],votes:[2100,1300,980,760]},{id:'p3',q:'Francia pasara el Grupo I?',opts:['Si 1a','Si 2a','No eliminada'],votes:[3200,800,150]}],
  pt:[{id:'p1',q:'Quem sera campeao do Mundo 2026?',opts:['Franca','Argentina','Espanha','Brasil'],votes:[1240,1580,980,1100]},{id:'p2',q:'Quem sera o melhor jogador?',opts:['Mbappe','Haaland','Vinicius','Bellingham'],votes:[2100,1300,980,760]},{id:'p3',q:'A Franca vai passar do Grupo I?',opts:['Sim 1a','Sim 2a','Nao eliminada'],votes:[3200,800,150]}],
  it:[{id:'p1',q:'Chi sara campione del Mondo 2026?',opts:['Francia','Argentina','Spagna','Brasile'],votes:[1240,1580,980,1100]},{id:'p2',q:'Chi sara il miglior giocatore?',opts:['Mbappe','Haaland','Vinicius','Bellingham'],votes:[2100,1300,980,760]},{id:'p3',q:'La Francia passera il Girone I?',opts:['Si 1a','Si 2a','No eliminata'],votes:[3200,800,150]}],
  de:[{id:'p1',q:'Wer wird Weltmeister 2026?',opts:['Frankreich','Argentinien','Spanien','Brasilien'],votes:[1240,1580,980,1100]},{id:'p2',q:'Wer wird der beste Spieler?',opts:['Mbappe','Haaland','Vinicius','Bellingham'],votes:[2100,1300,980,760]},{id:'p3',q:'Kommt Frankreich durch Gruppe I?',opts:['Ja 1.','Ja 2.','Nein ausgeschieden'],votes:[3200,800,150]}]
};

var AFFILIATES = {
  en:[{name:'Bet365',desc:'Up to 200 bonus',url:'https://www.bet365.com',color:'#027b5b'},{name:'Sky Bet',desc:'Get 30 free bets',url:'https://m.skybet.com',color:'#0077C0'},{name:'William Hill',desc:'30 free bet',url:'https://www.williamhill.com',color:'#7B0000'}],
  fr:[{name:'Winamax',desc:'Jusqu a 200EUR offerts',url:'https://www.winamax.fr',color:'#e8251f'},{name:'Unibet',desc:'Jusqu a 150EUR offerts',url:'https://www.unibet.fr',color:'#009B00'},{name:'PMU',desc:'200EUR de bonus',url:'https://www.pmu.fr',color:'#006AB3'}],
  ...
  it:[{name:'Sisal',desc:'Fino a 25EUR bonus',url:'https://www.sisal.it',color:'#e20025'},{name:'Snai',desc:'Fino a 100EUR gratis',url:'https://www.snai.it',color:'#003580'},{name:'Bet365',desc:'Bonus benvenuto',url:'https://www.bet365.com',color:'#027b5b'}],
  de:[{name:'Tipico',desc:'100EUR Willkommensbonus',url:'https://www.tipico.de',color:'#e30613'},{name:'Bet3000',desc:'Bis zu 100EUR Bonus',url:'https://www.bet3000.com',color:'#003366'},{name:'Bet365',desc:'Willkommensbonus',url:'https://www.bet365.com',color:'#027b5b'}]
};
...
function App(){
  ...
  function changeLang(code){setLang(code);setQIdx(0);setSelected(null);setScore(0);setQuizDone(false);setAnswered(false);}
  ...
  var headerStyle={background:'linear-gradient(90deg,#060f24,#122860,#060f24)',borderBottom:'2px solid '+G,padding:'10px 14px'};
  var navStyle={position:'sticky',top:0,zIndex:20,display:'flex',justifyContent:'center',flexWrap:'wrap',gap:3,background:'rgba(6,9,26,0.97)',backdropFilter:'blur(14px)',padding:'7px 10px',borderBottom:'1px solid rgba(212,175,55,0.16)'};
    ...
    e('main',{style:{padding:'16px 13px',maxWidth:740,margin:'0 auto'}},
      ...
      tab===0&&e('div',null,
        ...
        e('div',{style:{background:'linear-gradient(135deg,rgba(0,35,149,0.38),rgba(237,41,57,0.26))',border:'1.5px solid rgba(255,255,255,0.16)',borderRadius:14,padding:16,marginBottom:13}},
          ...
          ['France','Senegal','Iraq','Norway'].map(function(team,i){return e('div',{key:team,style:{display:'flex',alignItems:'center',gap:9,background:i===0?'rgba(255,255,255,0.14)':'rgba(255,255,255,0.04)',borderRadius:8,padding:'8px 11px',marginBottom:6}},e('span',{style:{fontSize:10,color:G,minWidth:16}},i+1,'.'),e('span',{style:{fontSize:12,fontWeight:i===0?'bold':'normal'}},team));}),
      ...
      tab===1&&e('div',null,
        ...
        e(Card,{style:{marginBottom:14,border:'1px solid '+G}},
          ...
          GROUPS[selGroup].teams.map(function(team,i){return e('div',{key:team,style:{display:'flex',alignItems:'center',gap:10,background:i===0&&GROUPS[selGroup].host?'rgba(212,175,55,0.14)':'rgba(255,255,255,0.04)',border:'1px solid rgba(212,175,55,0.1)',borderRadius:9,padding:'10px 13px',marginBottom:7}},e('div',{style:{width:22,height:22,borderRadius:5,flexShrink:0,background:i===0&&GROUPS[selGroup].host?G:'rgba(212,175,55,0.18)',display:'flex',alignItems:'center',justifyContent:'center',fontSize:10,fontWeight:'bold',color:i===0&&GROUPS[selGroup].host?'#0a0a1a':G}},i+1),e('span',{style:{fontSize:13}},team),i===0&&GROUPS[selGroup].host&&e('span',{style:{marginLeft:'auto',fontSize:9,color:G,background:'rgba(212,175,55,0.12)',padding:'2px 7px',borderRadius:8}},t.hostLabel));})
        ),
        e('div',{style:{display:'grid',gridTemplateColumns:'1fr 1fr',gap:7}},
          Object.entries(GROUPS).map(function(entry){var g=entry[0];var data=entry[1];return e('div',{key:g,onClick:function(){setSelGroup(g);},style:{background:g===selGroup?'rgba(212,175,55,0.09)':'rgba(10,20,50,0.8)',border:'1px solid '+(g===selGroup?G:BD),borderRadius:10,padding:10,cursor:'pointer'}},e('div',{style:{fontSize:10,fontWeight:'bold',color:G,marginBottom:5}},t.groupLabel,' ',g),data.teams.map(function(team){return e('div',{key:team,style:{fontSize:9,color:'#90aabf',marginBottom:2}},team);}));})
        )
      ),
      ...
      tab===4&&e('div',null,
        e('div',{style:{fontSize:10,color:G,marginBottom:14,textAlign:'center'}},t.starsSub),
        e('div',{style:{display:'flex',flexDirection:'column',gap:10}},
          STARS.map(function(s,i){
            return e(Card,{key:s.name,gold:i<3,style:{display:'flex',gap:14,alignItems:'center'}},
              e('div',{style:{width:44,height:44,borderRadius:12,background:i===0?'linear-gradient(135deg,'+G+',#ff9900)':i===1?'rgba(192,192,192,0.3)':i===2?'rgba(205,127,50,0.3)':'rgba(212,175,55,0.15)',display:'flex',alignItems:'center',justifyContent:'center',fontSize:14,fontWeight:'bold',color:i===0?'#0a0a1a':G,flexShrink:0}},i<3?['1st','2nd','3rd'][i]:s.flag),
              e('div',{style:{flex:1,minWidth:0}},
                e('div',{style:{display:'flex',alignItems:'center',gap:7,marginBottom:2}},e('span',{style:{fontSize:13,fontWeight:'bold'}},s.name),e('span',{style:{fontSize:9,padding:'2px 6px',borderRadius:8,background:'rgba(212,175,55,0.15)',color:G,fontWeight:'bold'}},s.pos)),
                ...
                e('div',{style:{display:'flex',alignItems:'center',gap:6}},e('div',{style:{flex:1,height:4,background:'rgba(255,255,255,0.1)',borderRadius:2,overflow:'hidden'}},e('div',{style:{width:((s.rating-85)/15*100)+'%',height:'100%',background:'linear-gradient(90deg,'+G+',#ff9900)',borderRadius:2}})),e('span',{style:{fontSize:11,color:G,fontWeight:'bold',minWidth:24}},s.rating))
              )
            );
          })
        )
